...
export const DFS_CODE: readonly CodeLine[] = [
  {
    number: 1,
    tokens: [
  ...
  },
  {
    number: 10,
    tokens: [
      { kind: 'text', text: '      depth.set(neighbor, depth.get(current)! ' },
      { kind: 'op', text: '+' },
      { kind: 'text', text: ' ' },
      { kind: 'num', text: '1' },
      { kind: 'text', text: ');' },
  ...
  {
    number: 11,
    tokens: [{ kind: 'text', text: '      stack.push(neighbor);' }],
  },
